...
This guide will help you get started with Macide.
...
Macide can be installed on Windows, macOS, and Linux. Visit the [download page](https://github.com/macide/macide/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing Macide, here are some first steps to get started:
...
Macide works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/macide/macide/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/macide/macide/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/macide/macide/blob/master/CONTRIBUTING.md) if you're interested

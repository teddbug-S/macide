...
# Copy Macide core TypeScript source into the bundled extension
if [[ -d "src/macide" ]]; then
  mkdir -p vscode/extensions/macide-core/src
  cp -rp src/macide/* vscode/extensions/macide-core/src/
fi
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "Macide - Insiders"
  setpath "product" "nameLong" "Macide — Multi-Account Copilot IDE (Insiders)"
  setpath "product" "applicationName" "macide-insiders"
  setpath "product" "dataFolderName" ".macide-insiders"
  setpath "product" "linuxIconName" "macide-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "macide-insiders"
  setpath "product" "publisher" "Macide"
  setpath "product" "serverApplicationName" "macide-server-insiders"
  setpath "product" "serverDataFolderName" ".macide-server-insiders"
  setpath "product" "darwinBundleIdentifier" "com.macide.MacideInsiders"
  setpath "product" "win32AppUserModelId" "Macide.MacideInsiders"
  setpath "product" "win32DirName" "Macide Insiders"
  setpath "product" "win32MutexName" "macideinsiders"
  setpath "product" "win32NameVersion" "Macide Insiders"
  setpath "product" "win32RegValueName" "MacideInsiders"
  setpath "product" "win32ShellNameShort" "Macide Insiders"
  ...
  setpath "product" "tunnelApplicationName" "macide-insiders-tunnel"
  setpath "product" "win32TunnelServiceMutex" "macideinsiders-tunnelservice"
  setpath "product" "win32TunnelMutex" "macideinsiders-tunnel"
  ...
  setpath "product" "nameShort" "Macide"
  setpath "product" "nameLong" "Macide — Multi-Account Copilot IDE"
  setpath "product" "applicationName" "macide"
  setpath "product" "dataFolderName" ".macide"
  setpath "product" "linuxIconName" "macide"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "macide"
  setpath "product" "publisher" "Macide"
  setpath "product" "serverApplicationName" "macide-server"
  setpath "product" "serverDataFolderName" ".macide-server"
  setpath "product" "darwinBundleIdentifier" "com.macide"
  setpath "product" "win32AppUserModelId" "Macide.Macide"
  setpath "product" "win32DirName" "Macide"
  setpath "product" "win32MutexName" "macide"
  setpath "product" "win32NameVersion" "Macide"
  setpath "product" "win32RegValueName" "Macide"
  setpath "product" "win32ShellNameShort" "Macide"
  ...
  setpath "product" "tunnelApplicationName" "macide-tunnel"
  setpath "product" "win32TunnelServiceMutex" "macide-tunnelservice"
  setpath "product" "win32TunnelMutex" "macide-tunnel"
...
replace 's|Microsoft Corporation|Macide|' package.json

cp resources/server/manifest.json{,.bak}

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "resources/server/manifest" "name" "Macide - Insiders"
  setpath "resources/server/manifest" "short_name" "Macide - Insiders"
else
  setpath "resources/server/manifest" "name" "Macide"
  setpath "resources/server/manifest" "short_name" "Macide"
fi
...
replace 's|Microsoft Corporation|Macide|' build/lib/electron.ts
replace 's|([0-9]) Microsoft|\1 Macide|' build/lib/electron.ts

if [[ "${OS_NAME}" == "linux" ]]; then
  # microsoft adds their apt repo to sources
  # unless the app name is code-oss
  # as we are renaming the application to macide
  # we need to edit a line in the post install template
  if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
    sed -i "s/code-oss/macide-insiders/" resources/linux/debian/postinst.template
  else
    sed -i "s/code-oss/macide/" resources/linux/debian/postinst.template
  fi
